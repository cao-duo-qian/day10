...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_typeid" id = "txt_search_typeid">
	...
	<div class="modal fade" id="modal_user_count" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 商品设备报表  </h4>
				</div>
				<div class="modal-body">
	...
	<div class="modal fade" id="modal_user_export" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 设备信息  </h4>
				</div>
				<div class="modal-body">
							导出所选记录？
				</div>
	...
	function initEditUser(getSelection){
		...
		$('#status option[value="'+getSelection.status+'"]').prop("selected",true);
